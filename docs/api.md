...
| `browser` | Required for VRT | Caller-owned Linux amd64 runtime; required for VRT, optional on E2E/component tests to select isolated execution |
| `target_platform` | Rules' Linux amd64 platform | Isolated input platform; override for caller native ABI constraints |
