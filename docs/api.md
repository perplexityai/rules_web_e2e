...
| `browser` | Required for VRT | Caller-owned `browser_runtime` with Linux amd64 Chromium, Node, libraries, and fonts |
| `target_platform` | Rules' Linux amd64 platform | VRT input platform; override for caller native ABI constraints |
